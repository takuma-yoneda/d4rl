...
def main(directory):
    ...
    env_name = 'maze2d-simple-multi-goal-v0'
    ...
    for goal in ['left', 'center', 'right']:
        print('goal', goal)
        env = maze_model.SimpleMultiGoalMazeEnv(goal=goal, reward_type='sparse', terminate_at_goal=True)
