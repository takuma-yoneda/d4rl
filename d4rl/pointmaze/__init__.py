from .maze_model import (
    ...
    SIMPLE_MULTI_GOAL,
    SIMPLE_TWO_GOALS,
    SimpleMultiGoalMazeEnv,
    SimpleTwoGoalsMazeEnv,
    SimpleTwoGoalsMazeEnv2,
    SimpleTwoGoalsMazeEnv3,
    FunnelGoalMazeEnv,
    MazeEnv,
    OPEN,
    U_MAZE,
...
register(
    id='maze2d-simple-two-goals-v0',
    entry_point='d4rl.pointmaze:SimpleTwoGoalsMazeEnv',
    max_episode_steps=600,
    kwargs={
        'maze_spec':SIMPLE_TWO_GOALS,
        # Below is copied from MEDIUM_MAZE_EVAL
        'reward_type':'sparse',
        'reset_target': False,
        'ref_min_score': 5.77,
...
register(
    id='maze2d-simple-two-goals-v1',
    entry_point='d4rl.pointmaze:SimpleTwoGoalsMazeEnv2',
    max_episode_steps=600,
    kwargs={
        'reward_type':'sparse',
        'reset_target': False,
...
register(
    id='maze2d-simple-two-goals-v2',
    entry_point='d4rl.pointmaze:SimpleTwoGoalsMazeEnv3',
    max_episode_steps=600,
    kwargs={
        'reward_type':'sparse',
        'reset_target': False,
